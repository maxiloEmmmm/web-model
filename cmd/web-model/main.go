...
func main() {
	...
	addrDefault := envOrDefault("ADDR", "127.0.0.1:8080")
	...
	flag.Usage = func() {
		...
		fmt.Fprintf(output, "    %s -addr 127.0.0.1:8080\n\n", os.Args[0])
		fmt.Fprintf(output, "  List registered models:\n")
		fmt.Fprintf(output, "    curl http://127.0.0.1:8080/v1/models\n\n")
		fmt.Fprintf(output, "  Chat once:\n")
		fmt.Fprintf(output, "    curl http://127.0.0.1:8080/v1/chat/completions \\\n")
